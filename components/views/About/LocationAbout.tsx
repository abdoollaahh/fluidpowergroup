  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="text-2xl w-full">
        <div className="relative h-80 sm:h-96 rounded-2xl overflow-hidden border max-w-[1200px] mx-auto">
          <a
          ...
          <div className="absolute top-0 left-0 p-8 sm:p-16 flex items-center h-full pointer-events-none">
