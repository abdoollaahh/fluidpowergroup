                    ...
                    <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                        ...
                        <tbody>
                            ${pwaOrders.map(order => `
                                <tr style="border-bottom: 1px solid #dee2e6;">
                                    <td style="padding: 12px;">
                                        <img src="https://cdn.swell.store/fluidpowergroup/6959b1f1b8c9d700121d9651/b54c1b05d3da6917392f6c4a7b34ec33/Hose360.png" alt="${order.name}" style="width: 50px; height: 50px; object-fit: contain; margin-right: 10px; vertical-align: middle; border-radius: 4px;">
                                        <div style="display: inline-block; vertical-align: middle;">
