...
export async function pushToQStash(orderData, callbackUrl) {
    ...
    try {
        ...
        // QStash v2 API format: POST to the URL directly, not encoded in path
 ...
 */
export function generateEmailTemplates(orderNumber, userDetails, websiteProducts, pwaOrders, totals, paypalCaptureID, TESTING_MODE) {
